    ...
    ui(new Ui::ui_agregarLente)
{
    ...
    ui->comboBox_tipoLente->ActualizarItems(tipoLente::mostrar());
    ui->comboBox_potencia->setTipo("potencia");
    ui->comboBox_potencia->ActualizarItems(potencia::mostrar());
    ui->comboBox_curvaBase->setTipo("curvaBase");
    ui->comboBox_curvaBase->ActualizarItems(curvaBase::mostrar());
    ...
    ui->comboBox_tiempoUso->ActualizarItems(tiempoUso::mostrar());
    ui->comboBox_material->setTipo("material");
    ui->comboBox_material->ActualizarItems(material::mostrar());
...
void ui_agregarLente::on_pushButton_aceptar_clicked()
{
    ...
    tipoLente pTipoLente;pTipoLente.setNombre(ui->comboBox_tipoLente->currentText());pTipoLente.completar();
    potencia pPotencia;pPotencia.setNombre(ui->comboBox_potencia->currentText());pPotencia.completar();
    curvaBase pCurvaBase;pCurvaBase.setValor(ui->comboBox_curvaBase->currentText());pCurvaBase.completar();
    diametro pDiametro;pDiametro.setValor(ui->comboBox_diametro->currentText());pDiametro.completar();
    tiempoUso pTiempoUso;pTiempoUso.setValor(ui->comboBox_tiempoUso->currentText());pTiempoUso.completar();
    material pMaterial;pMaterial.setNombre(ui->comboBox_material->currentText());pMaterial.completar();
